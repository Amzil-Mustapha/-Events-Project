...
<section class="mariage">
   ...
   <h1 class="heading">anniversaire filles</h1>
   ...
   <div class="swiper mariage-slider">
      ...
      <div class="swiper-wrapper">
         ...
         <div class="swiper-slide slide">
            <img src="images_site/birthday/girls/Arco de Balão Como Fazer + 42 Modelos Para Copiar.jpg" alt="">
            <div class="content">
         ...
         <div class="swiper-slide slide">
            <img src="images_site/birthday/girls/Festa Euphoria dicas e 60 ideias para uma festa inesquecível.jpg" alt="">
            <div class="content">
               <a href="contact.php" class="btn">demander</a>
            </div>
         </div>
