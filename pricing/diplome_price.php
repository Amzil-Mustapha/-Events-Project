...
<section class="pricing">
   ...
   <h1 class="heading">Féte De diplome</h1>

   <div class="box-container">

      <div class="box">
         <h3>Plan Basic</h3>
         <div class="price">DH 5 000/+</div>
         <div class="list">
         ...
         <a href="contact.php" class="btn">choisir ce pack</a>
      </div>

      <div class="box">
         <h3>Plan Premium </h3>
         <div class="price">DH 10 000/+</div>
         <div class="list">
