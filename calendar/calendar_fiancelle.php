    ...
    $calendar .= "<a class='btn btn-xs btn-primary' href='?month=".date('m', mktime(0, 0, 0, intval($month)+1, 1, $year))."&year=".date('Y', mktime(0, 0, 0, intval($month)+1, 1, $year))."'>Mois prochain</a></center><br>";
     ...
     while ($currentDay <= $numberDays) {
         ...
         if($date<date('Y-m-d')){
             ...
             $calendar.="<td class='$today'><h4>$currentDay</h4> <a href='../contact/contact_fiancelle.php?date=".$date."' class='btn btn-success btn-xs'> <span class='glyphicon glyphicon-ok' ></span> Résérver</a>";
...
<section>
    ...
    <h1 class="heading">Résérvation de Votre féte fiancelle</h1>
    <?php
